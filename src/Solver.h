...
struct SystemParameters {
    ...
    SolverMode mode;         // Calculation mode

    SystemParameters() : temperature(25.0), ionicStrength(0.0), pH(7.0), volume(1.0), mode(SolverMode::WebMaxC) {}
};
...
private:
    ...
    double calculatePKw(double temperature, double ionicStrength);
    double calculateHydroxideConcentration(double pH, double temperature, double ionicStrength);
    double calculateHActivityCorrection(double pH, double temperature, double ionicStrength);
    ...
    double getMetalHBindingConstant(const Ligand* ligand, const std::string& metalName);
    ...
    double getMetalHEnthalpyConstant(const Ligand* ligand, const std::string& metalName);
...
public:
    ...
    SystemParameters GetParameters() const { return params; }
    ...
    // Legacy wrappers for unit tests
