...
int main() {
    ...
    auto result1 = solver.CalculateTotalToFree(0.010, 0.005, "EGTA", "Ca2");
    std::cout << "Free Ca2+: " << result1.freeMetal * 1e9 << " nM\n";
    std::cout << "Expected: ~67.8 nM\n\n";
    
    std::cout << "=== Test Case 2: 10 mM EDTA, desired Free Mg2+ = 1 mM ===\n";
    auto result2 = solver.CalculateFreeToTotal(0.010, 0.001, "EDTA", "Mg2");
    std::cout << "Total Mg2+: " << result2.totalMetal * 1000.0 << " mM\n";
    ...
    // Known: total Mg = 1 mM (0.001 M), target free Ca = 100 nM (1e-7 M)
    // Find: total Ca needed, resulting free Mg
    auto result3 = solver.CalculateConstrainedMulti(0.005, {0.001}, {"Mg2"}, 1e-7, "Ca2", "BAPTA");
